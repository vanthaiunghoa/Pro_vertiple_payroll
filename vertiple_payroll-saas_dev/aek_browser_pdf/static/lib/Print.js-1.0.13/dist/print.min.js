...
// printJS class
        let PrintJS = function () {
            ...
            switch (typeof args[0]) {
                ...
                case 'object':
                    ...
                    print.params.printable_html = args[0].printable_html
            ...
            if (browser.isIE() && print.params.type === 'pdf') {
                ...
                // hide iframe
                print.printFrame.setAttribute('style', 'height: 0px;width: 0px;')
            }
        ...
        PrintJS.prototype.html = function () {
            ...
            if (!printElement && !this.params.printable_html) {
            ...
            if (printElement) {
                ...
                printableElement = document.createElement('div');
                printableElement.innerHTML = this.params.printable_html;
            }
        ...
        PrintJS.prototype.addHeader = function (printElement) {
            ...
            headerElement.innerHTML = this.params.header
        ...
        PrintJS.prototype.validateInput = function () {
            if (!this.params.printable && !this.params.printable_html) {
